...
const Home: NextPage<PageData> = ({ allProjectsData, allEventsData }) => {
  ...
  return (
    <div>
      ...
      <main>
        <div className="bg-dinocream pb-28 4xl:pb-52">
          ...
          <div className="mt-32 md:mt-52 lg:mt-64 xl:mt-96 bg-[linear-gradient(9deg,_#191919_50%,_#f6f2e7_50%)]">
            <div className="bg-tmblue dark:bg-coffeecream h-20 md:h-32 lg:h-40 xl:h-60 2xl:h-80 rotate-9 4xl:rotate-7 scale-125 shadow-glow"></div>
          </div>
