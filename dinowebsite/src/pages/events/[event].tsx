        ...
        <div>
            ...
            <main className="overflow-hidden">
                <div className="bg-dinocream pb-20">
                    <header
                        className="flex items-center justify-center h-[28rem] mb-12 bg-fixed bg-center bg-cover bg-[url('https://images.pexels.com/photos/162500/measurement-millimeter-centimeter-meter-162500.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] bg-no-repeat"
                    >
                    </header>
