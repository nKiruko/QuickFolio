    ...
    <div>
      ...
      <main className="bg-dinocream">
        ...
        <div className="mt-28 md:mt-40 lg:mt-52 xl:mt-60 bg-[linear-gradient(-9deg,_#191919_50%,_#f6f2e7_50%)]">
          <div className="bg-tmorange dark:bg-coffeegreen h-20 md:h-32 lg:h-40 xl:h-60 -rotate-9 4xl:-rotate-6 scale-125 shadow-glow"></div>
        </div>
        <div className="bg-dinoblack text-dinocream pb-16 4xl:pb-36">
          <div className="">
