...
const Project: FunctionComponent<ProjectDataProps> = ({ projectData }) => {
  return (
    <div className="mt-16 hover:cursor-pointer">
      <div className="hover:underline hover:underline-offset-4 hover:decoration-tmorange dark:hover:decoration-coffeegreen">
      ...
      <div className="font-sans xl:w-11/12 md:w-5/6 text-xs opacity-75 text-justify italic text-tmblue">{projectData.date}</div>
