...
export default function Event(props: MyProps) {   
   ...
   return (         
      <div className="mt-16 flex flex-col lg:flex-row  hover:cursor-pointer ">
         ...
         <div className={`lg:basis-3/4 md:w-5/6 mt-5 first-line:hover:underline first-line:hover:underline-offset-8 first-line:hover:decoration-tmorange ${props.left ? "lg:order-last lg:pl-10" : "lg:order-first lg:pr-10"}`}>
